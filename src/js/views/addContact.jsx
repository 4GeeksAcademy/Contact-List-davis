...
export const AddContact = () => {
	...
	return (
		<form className="container-fluid" onSubmit={handleSubmit}>
			<h1 className="mt-5 mx-auto p-3 text-center text-primary-emphasis
			...
			<div className="mb-3">
				...
				<input value={email} onChange={(e) => setEmail(e.target.value)} type="email" className="form-control" id="email" aria-describedby="email" placeholder="Ingrese correo electrónico" />
			</div>
			<div className="mb-3">
				<label className="form-label text-primary">Telefono</label>
				<input value={phone} onChange={(e) => setPhone(e.target.value)} type="text" className="form-control" id="phone" aria-describedby="phone" placeholder="Telefono" />
			</div>
			<div className="mb-3">
				<label className="form-label text-primary">Direccion</label>
				<input value={address} onChange={(e) => setAddress(e.target.value)} type="text" className="form-control" id="address" aria-describedby="address" placeholder="Ingresa la direccion" />
			</div>
			<div className="mb-3">
