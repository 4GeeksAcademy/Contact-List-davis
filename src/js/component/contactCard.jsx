				...
				return (
					<div key={contact.id} className="row border rounded m-2">
						<div className="col-3 col-lg-2 p-2 mx-4 my-auto">
							<img src="https://i.blogs.es/c554bd/portada/1366_2000.jpg" className="card-img rounded-circle" alt="..." />
						</div>
						<div className="col p-2 my-auto">
							<div className="row d-flex">
								...
								<div className="col text-secondary">
									...
									<div className="d-flex align-items-center grid gap-2">
										<i className="fa-sharp fa-solid fa-location-dot"></i> {contact.address}
									</div>
									<div className="d-flex align-items-center grid gap-2">
